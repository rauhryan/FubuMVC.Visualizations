...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Visualizations.Diagnostics"
COPYRIGHT = 'Copyright 2012 FubuMVC.Visualizations.Diagnostics. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Visualizations.Diagnostics.sln', :clrversion => CLR_TOOLS_VERSION
